;if(CloudflareApps.matchPage(CloudflareApps.installs['Sa9XlTXbSpV9'].URLPatterns)){(function(){'use strict'
var options=CloudflareApps.installs['Sa9XlTXbSpV9'].options
